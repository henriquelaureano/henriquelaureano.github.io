...
x <- c(
    1:31, 1:28+31, 1:31+31+28, 1:30+31+28+31, 1:31+31+28+31+30,
    1:30+31+28+31+30+31, 1:(7+14)+31+28+31+30+31+30
)
## 23 days per row
y <- c(
    ...
    1, 2, 1, 0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA
)
data.inla <- list(
    y=y, x=x
)
...
plot.curves <-
    ...
    annotate('text', label='JUL',
             x=10+31+28+31+30+31+30, y=4, color='#8A8D8F', size=5)+
