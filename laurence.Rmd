...
x <- c(
    1:31, 1:28+31, 1:31+31+28, 1:(7+14)+31+28+31
)
## 23 days per row
y <- c(
    ...
    2, 1, 1, 0, 0, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA
)
data.inla <- list(
    y=y, x=x
)
...
plot.curves <-
    ...
    geom_vline(xintercept=c(31, 28+31, 31+28+31), linetype='dashed')+
    ...
    annotate('text', label='APR',
             x=10+31+28+31, y=4, color='#8A8D8F', size=5)+
