...
x <- c(1:31,
       ...
       1:31+31+28+31+30,
       1:30+31+28+31+30+31,
       1:31+31+28+31+30+31+31,
       1:(11+14)+31+28+31+30+31+31+31)
y <- c(0, 0, 0, 1, 1, 2, 1, 1, 1, 1, 1, 3, 2, 0, 1, 0, 0, 0, 1, 1, 2, 2,
       ...
       3, 2, 1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA)
...
```{r fig.width=10,fig.height=5.25,warning=FALSE,error=TRUE}
...
plot.curves <-
    ...
    annotate('text', label=c('JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN',
             ...
             x=c(31/2,
                 ...
                 31/2+31+28+31+30,
                 30/2+31+28+31+30+31,
                 31/2+31+28+31+30+31+30,
                 31/2+31+31+28+31+30+31+30), y=4, color='#8A8D8F', size=5)+
    ...
    geom_point(data=data2plot[c(
                   ...
                   dplyr::first(which(cumsum(data.inla$y)>=300))), ],
