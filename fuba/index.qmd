...
weight <- c(48, 59, 59, 64, 71, 78, 85, 91, 92, 90, 106, 93, 99, 99,
            ...
            158, 175, 230, 218, 223, 244, 255, 265, 266)
...
p1 <- dat|>
    ...
    geom_label(aes(x = as.Date("2023/03/21"), y = 48*3,
                   label = "3 times initial weight"))+
    geom_label(aes(x = as.Date("2023/03/21"), y = 48*4,
                   label = "4 times initial weight"))+
    geom_label(aes(x = as.Date("2023/03/21"), y = 48*5,
                   label = "5 times initial weight"))+
    geom_point(size = 2)+
    geom_line()+
    scale_x_date(date_breaks = "2 day", date_labels = "%b %d")+
    scale_y_continuous(breaks = seq(50, 260, by = 15))+
    labs(x = NULL, y = NULL,
