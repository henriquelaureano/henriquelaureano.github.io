...
\textcolor{beamer@UIUCorange}{\textit{balance}} and
\textcolor{beamer@UIUCorange}{\textit{default}}.
...
\begin{adjustwidth}{2.5em}{0pt}
 With LDA we model the distribution of the predictors \(X\) separately
 in each of the response classes (i.e. given \(Y\)), and then use Bayes’
