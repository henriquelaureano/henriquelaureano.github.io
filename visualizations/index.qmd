...
both (3d).](linear_model_in_3d.png){width=70%}
...
(break/change points).](time_serie_with_breakpoints.png){width=60%}

***

![The curve fits obtained through each gradient descent iteration until
convergence, in red.](linear_model_gradient_descent.png){width=65%}

***

![Sequential Bayesian learning of a simple linear model with one
covariate.](sequential_bayesian_learning.png){width=70%}

***

![Clustering results of the DbScan algorithm for different *minpts*
parameter values.](dbscan_minpts.png){width=70%}

***

![Clustering results of the DbScan algorithm for different *eps*
parameter values.](dbscan_eps.png){width=70%}
...
contour.](deviance_with_quad_approx.png){width=75%}

***

![Deviance contours for a bivariate Gaussian with zero
mean.](deviance_contours.png){width=75%}

***

![Deviance contours with the parameters estimate at each optimization
algorithm function
evaluation.](deviance_contours_function_evaluations.png){width=80%}

***

![Posterior mean and 95% credible interval of a random walk model of 1st
order for smoothing splines without
intercept.](random_walk_smoothing_splines.png){width=70%}

***

![Spider plots.](spider_plot.png){width=80%}

![](spiders_plot.png){width=80%}

***

![Buffon's (500) needles problem.](buffon_needles.png){width=70%}
...
outliers.](logistic_linear_model.png){width=70%}

***

![Boxplot and histograms with some extra descriptive measures of the
marathon times of 40 guys.](marathon_times.png){width=80%}

***

![Pre and post-competition body measures.](pre_and_post.png){width=75%}

***

![Heatmap of pains distribution in a group of 98 elderlies during the
COVID-19 pandemic.](heatmap_pains.png){width=80%}

***

![Malaria incidence versus relative humidity in a five years period in
the Amazon biome.](malaria_versus_relative_humidity.png){width=80%}
