...
scenarios.\newline
For each scenario, we simulate \(\color{UniBlue}{\bm{400}}\) samples,
totalizing \({\color{UniBlue}{\bm{72}}} \times
{\color{UniBlue}{\bm{400}}} = {\color{UniBlue}{\bm{28800}}}\) model
fittings.
\end{block}
...
\vspace{-0.3cm}
\includegraphics[height=8cm]{../thesis/figures/bias2plotsd-2.png}

### Some simulation study results

\vspace{-0.3cm}
\includegraphics[height=8cm]{../thesis/figures/bias2plotsd-10.png}

### Some simulation study results

\vspace{-0.3cm}
\includegraphics[height=8cm]{../thesis/figures/bias2plotsd-11.png}

### Some simulation study results

\vspace{-0.3cm}
\includegraphics[height=8cm]{../thesis/figures/bias2plotsd-12.png}

### Some simulation study results

\vspace{-0.3cm}
\includegraphics[height=8cm]{../thesis/figures/bias2plotsd-13.png}
 ...
 \begin{block}{}
  ...
  \begin{enumerate}
   ...
   \item As expected, as the sample size increases the results get
         better;
   \vspace{0.15cm}
   \item Given the low data representativity,\newline
         the model needs a considerable amount of data to perform well;
   \vspace{0.15cm}
   \item In standard multinomial GLMMs, as bigger the clusters better
         the results.\newline
         In our CIF-based formulation, this characteristic is not so
         clear.
  \end{enumerate}
 \end{block}
\end{minipage}
