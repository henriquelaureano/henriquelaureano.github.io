...
- The full likelihood formulation is in terms of a generalized linear
  mixed model (GLMM) - a conditional approach (with fixed and
  random/latent effects).
  
- We handle the latent effects through an efficient 
