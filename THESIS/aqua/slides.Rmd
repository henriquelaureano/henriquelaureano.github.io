...
\begin{itemize}
 \item \textit{Not} usually, the \textcolor{UniBlue}{probability scale}.
\end{itemize}

### Clustered competing risks in the probability scale

for us, is more attractive possibility is to work on the
\textcolor{UniBlue}{probability scale},\newline focusing on the
cause-specific
...
g1+grid::textGrob('CIF=P[failure time, a given cause | features]')
```
