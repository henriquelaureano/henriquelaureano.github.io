...
> let's get even simpler, just a common variance

```{r jvv2_data,error=TRUE,cache=TRUE}
ys.jvv2 <- future_datasimu(J=J, n=5, beta=beta.easy, Sigma=diag(2))
```

```{r jvv2_guess}
guess.jvv2 <- getguess(dll=glm.dll,
                       y=ys.jvv2, beta=c(beta1=beta.easy[1],
                                         beta2=beta.easy[2]))
```
