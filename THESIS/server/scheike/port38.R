...
## date: 1-fev-2021
## scheike's pairwise model via PORT in the structure 38----------------
...
theta <- c(b1=initFixed[i, 1], b2=initFixed[i, 2],
           ...
           rho_14=atanh(0.1/sqrt(0.2*0.5)),
           rho_23=atanh(0.1/sqrt(0.3*0.4)),
...
opt <- try(nlminb(theta, scheike, t=t, delta=80, J=J, causes=causes),
           silent=TRUE)
