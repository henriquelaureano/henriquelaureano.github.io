...
Type objective_function<Type>::operator() ()
{
  ...
  Type cov12=0;
  Type cov13=rho[0] * sqrt(s2[0])*sqrt(s2[2]);
  Type cov14=rho[2] * sqrt(s2[0])*sqrt(s2[3]);
  Type cov23=rho[3] * sqrt(s2[1])*sqrt(s2[2]);
  Type cov24=rho[1] * sqrt(s2[1])*sqrt(s2[3]);
  Type cov34=0;
