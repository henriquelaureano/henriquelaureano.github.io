...
\begin{minipage}{.75\textwidth}
 \begin{itemize}
  \item Taking into account the
        \textcolor{mykindofblue}{within-family dependence} may reflect
        both disease \textbf{heritability} and the impact of shared
...
\begin{minipage}{.55\textwidth}
 \begin{shaded}
  And what we do? A hierarchical approach
 \end{shaded}
\end{minipage}
...
Thinking in the \textcolor{mykindofblue}{twins data} application,
\newline
the small group/family size is a problem that implies in the following
\[
 \text{cycle}: \quad
 \parbox{0.1\textwidth}{\centering small groups} \Rightarrow
 \parbox{0.175\textwidth}{\centering little information} \Rightarrow
 \parbox{0.125\textwidth}{\centering complex model} \Rightarrow
 \parbox{0.2\textwidth}{\centering bigger number of groups}
\]
\(\dots\) with this,\newline
computational challenges appear and have also to be overcome
\noindent{\color{notthefruitorange}\rule{.5\linewidth}{0.25mm}}

\pause
Besides, the data is very simple \(\dots\)

+ we just know if the event occured (yes or no) and the time
