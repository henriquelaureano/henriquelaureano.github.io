...
summarized in \autoref{fig:datasimu}.
...
passing all the probability mass to the censorship.  Low probabilities
imply few failures, making this model even harder to fit.  All these
behaviors are seen in Figure 16.

Thinking of epidemiological or public health problems, the reasonable
CIF behaviors are the ones presented in Figure 15 A).

As already expected from
