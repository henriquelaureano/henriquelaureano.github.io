...
the \citeonline{fine&gray} subdistribution model. A complete and
...
modelling framework. A comprehensive reference is \citeonline{GLM89}.
...
In the GLMM framework, we can accommodate all competing causes of
