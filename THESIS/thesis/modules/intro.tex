...
A survival model deals with survival experience. Usually, the survival
...
extensive detailing can be, again, found in \citeonline{kalb&prentice}.
...
and timing, \citeonline{SCHEIKE} proposed a pairwise composite
...
of \citeonline{SCHEIKE} albeit with a simpler framework taking advantage
...
\citeonline{GLM72}, with the support of a \textit{link function},
...
A comprehensive reference for GLMs is \citeonline{GLM89}.
...
\item Compare the results of our multinomial GLMM for clustered
  ...
  composite approach of \citeonline{SCHEIKE}.
\end{enumerate}
