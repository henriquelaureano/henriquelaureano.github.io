...
\begin{agradecimentos}
 ...
 yesterday. Yesterday is the shadow of today. The past is certified as a
 finished product. Anything which has ended is finished. The wisdom of
 the past is the light of the past. The light of the future casts the
 shadows of tomorrow.
\end{agradecimentos}
...
\begin{resumo}[]
  ...
  In the study of failure time data, a special case is the analysis of
  clustered competing risks data. In this kind of data, besides the
  presence of multiple response variables competing by the occurrence of
  an event, a failure, we have a cluster structure implying a
  within-cluster dependence between its elements.
...
\begin{resumo}[]
  \begin{otherlanguage*}{brazil}
    ...
    \textbf{Palavras-chave}: Riscos competitivos agrupados.
                             ...
                             Modelo linear generalizado misto multinomial.
                             TMB: Template Model Builder.
