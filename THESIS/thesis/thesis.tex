...
\preambulo{\small{Disserta\c{c}\~{a}o apresentada ao Curso de
    ...
    Matem\'{a}tica: M\'{e}todos Est\'{a}tisticos, Universidade Federal
    do Paran\'{a}, como parte das exig\^{e}ncias para a
    obten\c{c}\~{a}o do t\'{i}tulo de Mestre em Ci\^{e}ncias.}}
% ----------------------------------------------------------------------
% informações do PDF
\makeatletter
\hypersetup{
