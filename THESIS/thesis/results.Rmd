...
cerror <- function(data, true, data_label) {
    ...
    out <- error%>%
        ...
        dplyr::mutate(label=c('mean', 'q025', 'q975'),
...
bias('beta1', expression('Parameter:'~beta[1]))
bias('beta2', expression('Parameter:'~beta[2]))
bias('gama1', expression('Parameter:'~gamma[1]))
bias('gama2', expression('Parameter:'~gamma[2]))
bias('w1', expression('Parameter:'~w[1]))
bias('w2', expression('Parameter:'~w[2]))
...
out$v <- forcats::fct_recode(out$v,
                             ...
                             'BLOCK-DIAG MODEL'='2',
                             'COMPLETE MODEL'  ='3')
bias2plot(out, expression('Parameter:'~log(sigma[1]^2)))
...
out$v <- forcats::fct_recode(out$v,
                             ...
                             'BLOCK-DIAG MODEL'='2',
                             'COMPLETE MODEL'  ='3')
bias2plot(out, expression('Parameter:'~log(sigma[2]^2)))
...
out$v <- forcats::fct_recode(out$v,
                             ...
                             'BLOCK-DIAG MODEL'='2',
                             'COMPLETE MODEL'  ='3')
bias2plot(out, expression('Parameter:'~log(sigma[3]^2)))
...
out$v <- forcats::fct_recode(out$v,
                             ...
                             'BLOCK-DIAG MODEL'='2',
                             'COMPLETE MODEL'  ='3')
bias2plot(out, expression('Parameter:'~log(sigma[4]^2)))
```
...
```{r bias2plot2,fig.height=7,eval=FALSE}
