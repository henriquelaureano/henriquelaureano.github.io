...
Type objective_function<Type>::operator() ()
{
  ...
  Sigma.row(0) << exp(logs2(0)), rho(0) * exp(logs2(0)), 0, 0;
  Sigma.row(1) << rho(0) * exp(logs2(0)), exp(logs2(0)), 0, 0;
  Sigma.row(2) << 0, 0, exp(logs2(1)), rho(1) * exp(logs2(1));
  Sigma.row(3) << 0, 0, rho(1) * exp(logs2(1)), exp(logs2(1));
  // -------------------------------------------------------------------
