...
\begin{minipage}[t]{.435\textwidth}
 \raggedright
 Resid\^{e}ncia: Pinheirinho, Curitiba-PR\\
 email:
...
\begin{itemize}
 \item[2022-] Cientista de Dados,\\
              Volvo
  \begin{itemize}
  \item Cientista de Dados na divis\~{a}o de Caminh\~{o}es e \^{O}nibus
        da Volvo (Grupo Volvo / Volvo do Brasil), atuando no time de
        Advanced Analytics.
  \end{itemize}
\end{itemize}
