...
\begin{minipage}[t]{.435\textwidth}
 \raggedright
 Resid\^{e}ncia: Vila Izabel, Curitiba-PR\\
 email:
...
\begin{itemize}
 \item[2021-] Estat\'{i}stico,\\
  ...
  \item O Instituto de Pesquisa Pel\'{e} Pequeno Pr\'{i}ncipe,
        ...
        Trabalho com a
        \href{https://henriquelaureano.github.io/visualizations/}{
          \color{blue}visualiza\c{c}\~{a}o de dados}, desenho/plano
 ...
 \item Linguagens de programa\c{c}\~{a}o
  \begin{itemize}
   \item \texttt{R} (\texttt{Shiny}, \texttt{tidyverse},
     ...
     \href{https://henriquelaureano.github.io/visualizations/}{
       \color{blue}etc}): Conhecimento avan\c{c}ado
