 ...
 \item[2010-2011] Estagi\'{a}rio,\\
  ...
  \begin{itemize}
   \item Estagi\'{a}rio da Coordenadoria do Interior (COI),
         ...
         documentos e materiais indo e vindo das regionais da PGE, entrega
         de tais documentos nos demais setores da PGE e entrega e retirada
         de documentos nos demais \'{o}rg\~{a}os da cidade de Curitiba.
  \end{itemize}
\end{itemize}
