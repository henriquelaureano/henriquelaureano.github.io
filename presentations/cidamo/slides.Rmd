...
Num modelo de regress\(\~{a}\)o temos \(Y = g(X\beta) + \epsilon\).
...
\begin{center}
\includegraphics[width=.775\linewidth]{logistic-relations.jpg}
\end{center}

\vspace{-.45cm}
\noindent{\color{beamer@UIUCorange}Exemplos,~\rule{.7\linewidth}{0.25mm}}
\vspace{-.45cm}
\begin{minipage}{.85\linewidth}
...
\centering
\includegraphics[width=.65\linewidth]{willy_wonka.jpg}
