...
<<hypergeo-c, fig.height=5.5, fig.cap="log-likelihood of \\(N\\) in Hypergeometric(N, K = 300, n = 250) based on \\(k = 12\\). In dashed, the MLE. Different ranges of \\(N\\) to have a better understanding of the likelihood behaviour.">>=
# <r code> -----
# likelihood -------------------------------------------------------------
