...
subdistribution \citep{fine&gray}. {\color{red} In family studies or
  ...
  process, the CIF is a very suitable modeling choice having the bonus
...
differentiation routines. {\color{red} We use the CIF specification as
  \cite{SCHEIKE}, but with a different likelihood formulation and
  parameter and uncertainty estimation and quantification. Instead of a
  composite likelihood and Adaptative Gaussian Quadrature routine we
  propose a full-likelihood formulation combined with an efficient
