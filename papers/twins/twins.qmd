...
#| tbl-cap: "Summary for the mean structure of the AE bivariate model."
...
#| tbl-cap:
#|   "Summary for the covariance structure of the AE bivariate model."

## (`r round(var(dat$TREC)`)
## (`r round(var(dat$KREC), 4)`)
## (`r round(cov(dat$TREC, dat$KREC), 4)`)
