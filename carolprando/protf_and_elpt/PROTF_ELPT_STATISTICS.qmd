...
Dos 4.961 que fizeram PROTF, 397 apresentaram valor abaixo da linha de corte mais que uma vez. Ou seja, 8% dos pacientes.
...
Dos 2.543 que fizeram ELPT, 48 apresentaram valor abaixo da linha de corte mais que uma vez. Ou seja, 1.9% dos pacientes.
...
Dos 6.948 pacientes (total, ambos ou apenas um), 504 apresentaram valor abaixo da linha de corte mais que uma vez. Ou seja, 7.2% dos pacientes.
...
protf |> 
  ...
  writexl::write_xlsx(
    paste0(
      '/Users/henriquelaureano/git/henriquelaureano.github.io/',
      'carolprando/protf_and_elpt/protf_dplicacoes.xlsx'
    )
  )
...
elpt |> 
  ...
  writexl::write_xlsx(
    paste0(
      '/Users/henriquelaureano/git/henriquelaureano.github.io/',
      'carolprando/protf_and_elpt/elpt_duplicacoes.xlsx'
    )
  )
```
