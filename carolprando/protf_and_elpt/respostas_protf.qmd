...
146 pacientes vieram a óbito (18.29%), com um tempo médio de sobrevida de 190 dias (6.3 meses) - mediana de 38 dias (1.2 meses). 

**Atenção**! Temos dois pacientes com tempo negativo.
...
117 pacientes (14.7%) tem registro do valor de IgG e não fizeram reposição.
...
Correlação linear de Pearson de 0.43 (forte e estatísticamente significativa, 1.7e-06 = 0.0000017).
...
PROTF médio de 1.749, min 1.2 e máx 2.4.
...
61 pacientes, 31 diferentes combinações de comorbidades - apenas 5 ocorrendo em ao menos dois pacientes.
...
125 pacientes, descartaremos da análise aquele único paciente com IgG acima do valor de referência.
