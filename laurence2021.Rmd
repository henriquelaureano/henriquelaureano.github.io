---
title: "Laurence's 2021 solo daily activity"
...
y <- c(0, 0, 0, 1, 1, 2, 1, 1, 1, 1, 1, 3, 2, 0, 1, 0, 0, 0, 1, 1, 2, 2,
       ...
       0, 1, 2, 2, 0, 0, 0, 0, 0, 1, 1, 1, 1)
dat <-
    tibble::tibble(Day=seq(as.Date('2021-01-01'), as.Date('2021-12-31'),
                           by='days'),
...
dat|>
    ...
    labs(title='Laurence’s 2021 solo daily activity',
         subtitle=paste0(
...
```{r laurence_points_and_lines,fig.align='center',fig.width=10,fig.height=6.5}
...
p1 <- dats|>
    ...
    annotate('text',
             x=12, y=72.5, label=paste('Mean:', mean(dats$n)), 
...
p2 <- dats|>
    ...
    geom_hline(aes(yintercept=mean(m)),
               color='#ff0000', size=1, linetype='dashed')+
    geom_text(aes(x='Dezembro', y=2.375,
    ...
    scale_y_continuous(breaks=seq(1.6, 3, by=0.15))+
