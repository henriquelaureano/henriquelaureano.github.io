---
title: "Indicadores de malária: Precipitação"
...
library(knitr)
options(width=100)
knitr::opts_chunk$set(fig.path='figuras_precipitacao//',
                      fig.align='center',
                      ## dev=c('pdf', 'png'),
...
```{r suscetibilidade_social,fig.width=10}
...
```{r indice_de_risco_de_impacto_para_precipitacao,fig.width=10}
...
```{r indice_de_risco_de_impacto_para_precipitacao_media}
