---
title: "Indicadores de malária: Precipitação (Sem NAs)"
...
library(knitr)
options(width=100)
knitr::opts_chunk$set(fig.path='figuras_precipitacao_semnas/',
                      fig.align='center',
                      ## dev=c('pdf', 'png'),
...
```{r indice_de_risco_de_impacto_para_precipitacao}
