---
title: "Indicadores de malária: Umidade Relativa"
...
library(knitr)
options(width=100)
knitr::opts_chunk$set(fig.path='figuras_umidaderelativa/',
                      fig.align='center',
                      ## dev=c('pdf', 'png'),
...
```{r indice_de_risco_de_impacto_para_umidade_relativa,fig.width=10}
...
```{r indice_de_risco_de_impacto_para_umidade relativa_pca}
